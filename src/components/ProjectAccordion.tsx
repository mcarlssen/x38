  ...
  const sections: ProjectSection[] = [
    {
      ...
      items: [
        ...
        {
          title: 'Git Contact Finder',
          summary: 'Discover email patterns from public git commits.',
          description: (
            <>
            <p className="valueprop"><b>VALUE PROP:</b> sales and recruiting professionals can discover the email format used by any organization, improving cold outreach success rates — all processed locally with zero data stored.</p>
            <p className="problem">PROBLEM: When cold-emailing someone at an organization, guessing the email format (firstname@, firstname.lastname@, f.lastname@, etc.) is frustrating and time-consuming. This wastes effort and can harm sender reputation.</p>
            <p className="solution">SOLUTION: Git Contact Finder analyzes public commit data from any GitHub repository to reveal email patterns used by that organization's developers. A privacy-first design means no data is stored server-side or collected beyond your browser session — and since all commit data is already public, there's no breach of organizational privacy.</p>
            <p className="product-image"><img src="/images/gitcontactfinder.webp" alt="Git Contact Finder"/></p>
            <p><a href="https://github.com/mcarlssen/gitcontactfinder" target="_blank" rel="noopener noreferrer">https://github.com/mcarlssen/gitcontactfinder</a><br/>
            <span className="builtwith">Built with Next.js, TypeScript, and Tailwind CSS, deployed on Vercel.</span></p>
            </>
          ),
          featureIcon: (
    ...
    },
    {
      ...
      items: [
        {
          title: '#OpenToWork Badge',
          summary: 'A LinkedIn-like "Open to Work" profile picture with caption sash.',
          description: (
            <>
              <p className="valueprop"><b>VALUE PROP:</b> A fully customizable, zero-dependencies React component that adds a professional "Open to Work" badge overlay to profile pictures, perfect for portfolios and personal websites.</p>
              <p className="problem">PROBLEM: Creating a professional-looking badge overlay for profile pictures typically requires custom CSS, SVG manipulation, and careful positioning. This can be time-consuming and difficult to maintain consistently across different projects.</p>
              <p className="solution">SOLUTION: OpenToWork Badge is a ready-to-use React component with extensive customization options including size, colors, gradient effects, text positioning, and animation. It handles all the complex SVG path calculations and positioning automatically, making it easy to add a polished badge overlay to any headshot image.</p>
              <p className="product-image"><img src="/images/opentowork-badge-demo.webp" alt="opentowork-badge" /></p>
              <p className="project-link"><a href="https://github.com/mcarlssen/opentowork-badge" target="_blank" rel="noopener noreferrer">https://github.com/mcarlssen/opentowork-badge</a>
                <br />npm install @mcarlssen/opentowork-badge
                <br/><span className="builtwith">Built with React, TypeScript, and vanilla CSS.</span></p>
            </>
          ),
          featureIcon: (
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" className="feature-icon">
        ...
        {
          title: 'TypeOn',
          summary: 'A classic typewriter effect for text animation.',
          description: (
            <>
              <p className="valueprop"><b>VALUE PROP:</b> A lightweight, zero-dependency React component that adds engaging typewriter-style text animation to any project, with full control over typing speed and pause duration.</p>
              <p className="problem">PROBLEM: Many typewriter effect libraries are heavy, have unnecessary dependencies, or lack the flexibility needed for different use cases. Creating a custom typewriter effect from scratch requires managing state, timing, and animation logic.</p>
              <p className="solution">SOLUTION: TypeOn is a simple, focused React component with zero dependencies (except React itself). It cycles through an array of phrases with customizable typing speed and pause duration, making it easy to add dynamic text effects to landing pages, hero sections, or any interface that benefits from animated text.</p>
              <p className="product-image"><img src="/images/typeon-react-demo.webp" alt="typeon-react" /></p>
              <p className="project-link"><a href="https://github.com/mcarlssen/typeon-react" target="_blank" rel="noopener noreferrer">https://github.com/mcarlssen/typeon-react</a>
                <br />npm install @mcarlssen/typeon-react
                <br/><span className="builtwith">Built with React and TypeScript.</span></p>
            </>
          ),
          featureIcon: (
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" className="feature-icon">
